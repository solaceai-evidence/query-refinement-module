...
class MockQueryAnalyzer(QueryAnalyzerInterface):
    ...
    def analyze_aspect(
        ...
        return AspectAnalysisResult(
            ...
            reason=f"Mock analysis for {aspect.name}",
            suggested_question=f"Please clarify {aspect.name}?",
        )
    ...
    def test_dependency_graph_levels(self):
        ...
        aspects = [
            RefinementAspect(
                ...
                analysis_prompt="Analyze demographics",
                depends_on=None,
            ),
            RefinementAspect(
                ...
                analysis_prompt="Analyze clinical profile",
            ...
            RefinementAspect(
                ...
                analysis_prompt="Analyze intervention",
            ...
            RefinementAspect(
                ...
                analysis_prompt="Analyze comparison",
            ...
            RefinementAspect(
                ...
                analysis_prompt="Analyze outcomes",
            ...
            RefinementAspect(
                ...
                analysis_prompt="Analyze study design",
                depends_on=["population_demographics", "population_clinical_profile", 
    ...
    async def test_parallel_execution_sequential_chain(self):
        ...
        aspects = [
            ...
            RefinementAspect(
                ...
                analysis_prompt="Analyze B",
                depends_on=["aspect_a"],
            ),
            RefinementAspect(
                id="aspect_c",
                name="Aspect C",
                description="Third aspect",
                analysis_prompt="Analyze C",
                depends_on=["aspect_b"],
            ),
            RefinementAspect(
                id="aspect_d",
                name="Aspect D",
                description="Fourth aspect",
                analysis_prompt="Analyze D",
                depends_on=["aspect_c"],
            ),
        ]
